...
test('New API adapter performs only identity and dated status GETs', async () => {
  ...
  const identity=await adapter.methods.identity({expectedIdentity:'7',context:{request:async(path,options)=>{calls.push([path,options.method]);return {status:200,body:{success:true,data:{id:7,username:'reader',access_token:'TEST'}}};}}});
