...
test('adapter evidence stays a separate sanitized observation report',()=>{
 const input={mode:'observe_only',results:[{origin:'https://fixture.example',status:'signed',accountKey:'primary',identity:{userId:'123',username:'reader',password:'TEST'},evidence:{authoritative:true,source:'api',cookie:'TEST'},mutationCount:0}]};
