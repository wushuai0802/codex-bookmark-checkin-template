...
const row = () => ({origin:args.origin,accountKey:args.accountKey,userId:'12345',username:'reader',source:'user-self',observedAt:args.now,bindingKey:identityBinding(args.config,args.root,args.origin,args.accountKey),password:'TEST'});
