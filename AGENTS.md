...
check-in automation. V2.0-alpha is read-only: it observes the legacy runner
and produces a redacted plan/result snapshot. It must not click a check-in
...
- Every task has one execution owner. V2 alpha's owner is
