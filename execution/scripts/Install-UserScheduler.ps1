...
$command = "wscript.exe //B //NoLogo `"$supervisorScript`" `"$shell`" primary"
...
$shortcut.Arguments = "//B //NoLogo `"$supervisorScript`" `"$shell`" fallback"
...
Start-Process -FilePath 'wscript.exe' -ArgumentList @('//B', '//NoLogo', "`"$supervisorScript`"", "`"$shell`"", 'primary') -WindowStyle Hidden
