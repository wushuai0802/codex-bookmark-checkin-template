...
2. Bookmark scope, before every other preference: Chrome profile name or Auto; optional Edge profile name, Auto, or None; Chrome parent/target folder names; and, when different, Edge parent/target folder names. Offer candidates found by preflight, but do not preselect or infer names.
